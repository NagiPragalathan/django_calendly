...
def add_custom_field_to_leads(access_token):
    # Module is included in the URL
    ...
    payload = {
        "fields": [
            {
                "field_label": "Test Sample",  # Use `field_label` as per Zoho's requirements
                "api_name": "Test_Sample",
                "data_type": "text"  # Specify the field type
            }
        ]
    }
...
try:
    ...
    # Step 2: Add the Custom Field to Leads Module
    response = add_custom_field_to_leads(access_token)
