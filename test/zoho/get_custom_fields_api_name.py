...
# Get field details from the Events module
def get_event_fields(access_token):
    ...
    if response.status_code == 200:
        ...
        print("\n✅ Available Custom Fields in Zoho CRM (Events Module):\n")
        for field in fields:
            print(f"Display Name: {field['field_label']}  |  API Name: {field['api_name']}")
